...
const About: React.FC = () => {
  ...
  const text = [
    ...
    <p>
      ...
      <em>differences</em> in paintings. Find all the differences between the
      images to reveal information about the painting. The motivation for this
      project was to:
    </p>,
    <ul>
      ...
      <li>
        Explore the use of stable diffusion and other image generators for
        in-painting.
      </li>
    </ul>,
    <p>
