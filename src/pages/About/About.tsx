...
const About: React.FC = () => {
  ...
  const text = [
    <h1><EuiIcon type="questionInCircle" size="xl" /> About</h1>,
    <p>
This is a Spot the Gen - an app which uses generative AI to create{' '}
      <em>differences</em> in paintings. Find all the differences between the images to reveal information about the
...
This project is licensed under the MPL 2.0 license.
  ...
  return (
    <>
      <EuiPanel style={{ maxWidth: 600, margin: 'auto', position: 'relative'}}>
        <EuiButtonIcon style={{position: 'absolute', right:'5px'}}iconType="arrowLeft" size="m" href='./' />
        <EuiText color={euiTheme.euiTheme.colors.text}>
          {text}
        </EuiText>
